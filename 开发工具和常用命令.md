...
> Ctrl + E	最近的文件
> plugins:
> Lombok-Java库	Translation-翻译	Rainbow Brackets-彩虹括号	
> Grep Console-日志颜色	Statistic-代码统计	Markdown Navigator
> RestfulToolkit	GsonFormat	MyBatis Log Plugin	Free Mybatis plugin
> codeGlance2-代码缩略图：Viewport-FF4040
> Alibaba Cloud AI Coding Asststant-代码智能补全和代码示例搜索
> ctrl+shilt+s唤起代码文档搜索
> ```
> 类注释模板
>
> 1.创建类时

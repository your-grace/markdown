...
![img](https://github.com/your-grace/markdown/blob/main/image/net/1.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/2.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/3.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/4.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/5.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/6.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/7.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/8.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/9.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/10.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/11.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/12.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/13.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/14.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/15.png?raw=true)

## Socket

即套接字，是应用层 与 `TCP/IP` 协议族通信的中间软件抽象层，表现为一个封装了 TCP / IP协议族 的编程接口（API）

![img](https://github.com/your-grace/markdown/blob/main/image/net/16.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/17.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/18.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/19.png?raw=true)
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/20.png?raw=true)
...
1. 数据链路层构建一个数据帧，目的地址是IP层传过来的MAC地址，源地址是本机的MAC地址，再附加一些必要的控制信息，依据以太网的介质访问规则将他们传送出去
2. 机器B收到这个数据帧后，先检查目的地址，和本机MAC地址对比：
...
![img](https://github.com/your-grace/markdown/blob/main/image/net/21.png?raw=true)
